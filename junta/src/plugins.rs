...
// Same as https://github.com/reem/rust-plugin but with ShareMap
...
pub trait Pluggable {
        ...
        Self: Extensible,
    {
        ...
        P::eval(self).map(move |data| match self.extensions_mut().entry::<P>() {
...
mod test {
    ...
    use super::{Extensible, Pluggable, Plugin};
